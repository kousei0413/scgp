        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 text-xs font-bold tracking-wider uppercase">
            <button 
              ...
              className="hover:text-yellow-600 transition-colors flex items-center gap-1 focus:outline-none text-yellow-100"
            >
            ...
            <a 
              ...
              className="hover:text-yellow-600 transition-colors flex items-center gap-1 text-yellow-100"
            >
